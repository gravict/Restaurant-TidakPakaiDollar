 ...
 * 
 */
@WebServiceClient(name = "AccountWS", targetNamespace = "http://services.restaurant.com/", wsdlLocation = "http://localhost:8080/RestaurantWebService/AccountWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTWS_QNAME = new QName("http://services.restaurant.com/", "AccountWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/RestaurantWebService/AccountWS?wsdl");
    ...
    public AccountWS getAccountWSPort() {
        return super.getPort(new QName("http://services.restaurant.com/", "AccountWSPort"), AccountWS.class);
    }
    ...
    public AccountWS getAccountWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.restaurant.com/", "AccountWSPort"), AccountWS.class, features);
    }
